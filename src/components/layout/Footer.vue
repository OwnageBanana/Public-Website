...
<template>
  <div class="footer">
    <div>
      ...
      <a href="https://bsky.app/profile/adhocslime.bsky.social" target="none">
        <i class="icon bsky" aria-hidden="true">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -8 600 530" width="600px" height="530px" version="1.1">
...
.bsky  {
  transform: scale(1/4.6875, 1/4.6875);
}
</style>
